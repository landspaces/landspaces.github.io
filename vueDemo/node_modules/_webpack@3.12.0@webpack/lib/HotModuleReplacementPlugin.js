...
*/
"use strict";
const Template = require("_webpack@3.12.0@webpack/lib/Template");
...
const ConstDependency = require("_webpack@3.12.0@webpack/lib/dependencies/ConstDependency");
const NullFactory = require("_webpack@3.12.0@webpack/lib/NullFactory");
const ParserHelpers = require("_webpack@3.12.0@webpack/lib/ParserHelpers");
...
const hotInitCode = Template.getFunctionContent(require("_webpack@3.12.0@webpack/lib/HotModuleReplacement.runtime.js"));
