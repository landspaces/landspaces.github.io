...
const HarmonyImportDependency = require("_webpack@3.12.0@webpack/lib/dependencies/HarmonyImportDependency");
const ModuleHotAcceptDependency = require("_webpack@3.12.0@webpack/lib/dependencies/ModuleHotAcceptDependency");
const ModuleHotDeclineDependency = require("_webpack@3.12.0@webpack/lib/dependencies/ModuleHotDeclineDependency");
const ConcatenatedModule = require("_webpack@3.12.0@webpack/lib/optimize/ConcatenatedModule");
const HarmonyExportImportedSpecifierDependency = require("_webpack@3.12.0@webpack/lib/dependencies/HarmonyExportImportedSpecifierDependency");
const HarmonyCompatibilityDependency = require("_webpack@3.12.0@webpack/lib/dependencies/HarmonyCompatibilityDependency");
