...
const SetVarMainTemplatePlugin = require("_webpack@3.12.0@webpack/lib/SetVarMainTemplatePlugin");
	...
	apply(compiler) {
		compiler.plugin("this-compilation", (compilation) => {
			if(this.exportProperty) {
				var ExportPropertyMainTemplatePlugin = require("_webpack@3.12.0@webpack/lib/ExportPropertyMainTemplatePlugin");
			...
			switch(this.target) {
				...
				case "commonjs-module":
					...
					break;
				case "amd":
					var AmdMainTemplatePlugin = require("_webpack@3.12.0@webpack/lib/AmdMainTemplatePlugin");
					compilation.apply(new AmdMainTemplatePlugin(this.name));
					break;
				case "umd":
				case "umd2":
					var UmdMainTemplatePlugin = require("_webpack@3.12.0@webpack/lib/UmdMainTemplatePlugin");
					...
					break;
				case "jsonp":
					var JsonpExportMainTemplatePlugin = require("_webpack@3.12.0@webpack/lib/JsonpExportMainTemplatePlugin");
