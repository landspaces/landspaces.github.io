...
const Compilation = require("_webpack@3.12.0@webpack/lib/Compilation");
const Stats = require("_webpack@3.12.0@webpack/lib/Stats");
const NormalModuleFactory = require("_webpack@3.12.0@webpack/lib/NormalModuleFactory");
const ContextModuleFactory = require("_webpack@3.12.0@webpack/lib/ContextModuleFactory");

const makePathsRelative = require("_webpack@3.12.0@webpack/lib/util/identifier").makePathsRelative;
